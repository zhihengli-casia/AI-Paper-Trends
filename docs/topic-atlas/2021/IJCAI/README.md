...
| [015](topic-015.md) | LLM Agent 与工具使用 | 19 | 2.63% | 理论/优化 | `fairness / agents / goods / allocation` | Picking Sequences and Monotonicity in Weighted Fair Division |
| [016](topic-016.md) | nas / snns / neural architecture / verification | 18 | 2.49% | 系统/效率/压缩 | `nas / snns / neural architecture / verification` | Hardware-Aware Neural Architecture Search: Survey and Taxonomy |
...
| [021](topic-021.md) | 语音/音频语言模型 | 17 | 2.35% | 3D/具身/机器人 | `pose / human / point / head` | Learning 3-D Human Pose Estimation from Catadioptric Videos |
...
| [033](topic-033.md) | 时间序列建模与预测 | 10 | 1.39% | 可信/安全/公平 | `domain / adaptation / source / target` | Robust Domain Adaptation: Representations, Weights and Inductive Bias (Extended Abstract) |
| [034](topic-034.md) | 推荐系统与用户建模 | 9 | 1.25% | 多模态/VLM | `molecular / interaction / prediction / patient` | CSGNN: Contrastive Self-Supervised Graph Neural Network for Molecular Interaction Prediction |
...
| [037](topic-037.md) | 对抗攻击、鲁棒性与安全 | 8 | 1.11% | 计算机视觉 | `face / attribute / image / synthesis` | You Get What You Sow: High Fidelity Image Synthesis with a Single Pretrained Network |
| [038](topic-038.md) | 文档摘要与信息压缩 | 8 | 1.11% | NLP任务 | `video / spatiotemporal / localization / spatio-temporal` | Self-Supervised Video Representation Learning with Constrained Spatiotemporal Jigsaw |
