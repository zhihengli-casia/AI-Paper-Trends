...
|---|---|---:|---:|---|---|---|
| [000](topic-000.md) | mml / image / matching / recognition | 29 | 4.92% | 计算机视觉 | `mml / image / matching / recognition` | Vector of Locally and Adaptively Aggregated Descriptors for Image Feature Representation |
| [001](topic-001.md) | 机器翻译与跨语言对齐 | 27 | 4.58% | 计算机视觉 | `image / super-resolution / real-world / enhancement` | Single-Image super-resolution - When model adaptation matters |
| [002](topic-002.md) | 目标检测与图像分割 | 27 | 4.58% | 计算机视觉 | `object detection / small / objects / convolutional neural` | Spatial context-aware network for salient object detection |
| [003](topic-003.md) | pedestrian / object / 视频理解/生成 / tracking | 26 | 4.41% | 计算机视觉 | `pedestrian / object / video / tracking` | Optical flow and scene flow estimation: A survey |
| [004](topic-004.md) | 目标检测与图像分割 | 26 | 4.41% | 计算机视觉 | `chest / images / lung / diagnosis` | SARS-Net: COVID-19 detection from chest x-rays by combining graph convolutional network and convolutional neural network |
| [005](topic-005.md) | regression / ordinal / distribution / mml | 25 | 4.24% | 可信/安全/公平 | `regression / ordinal / distribution / mml` | Multi-complementary and unlabeled learning for arbitrary losses and models |
...
| [013](topic-013.md) | action / recognition / human / generation | 16 | 2.72% | 计算机视觉 | `action / recognition / human / generation` | Arbitrary-view human action recognition via novel-view action generation |
| [014](topic-014.md) | 自动驾驶感知与世界模型 | 15 | 2.55% | 多模态/VLM | `semantic segmentation / network semantic / fusion / driving` | EFNet: Enhancement-Fusion Network for Semantic Segmentation |
...
| [027](topic-027.md) | document / years / word / articles | 12 | 2.04% | 计算机视觉 | `document / years / word / articles` | Joint stroke classification and text line grouping in online handwritten documents with edge pooling attention networks |
| [028](topic-028.md) | 对抗攻击、鲁棒性与安全 | 11 | 1.87% | 生成模型 | `generative adversarial / face / generation / synthesis` | IsGAN: Identity-sensitive generative adversarial network for face photo-sketch synthesis |
| [029](topic-029.md) | 图学习 / pooling / hand / action | 10 | 1.70% | HCI/社会计算 | `graph / pooling / hand / action` | Normalized edge convolutional networks for skeleton-based hand gesture recognition |
...
| [031](topic-031.md) | 检索 / cross-modal / entropy / gap | 10 | 1.70% | 计算机视觉 | `retrieval / cross-modal / entropy / gap` | Robust and discrete matrix factorization hashing for cross-modal retrieval |
...
| [033](topic-033.md) | 目标检测与图像分割 | 9 | 1.53% | 多模态/VLM | `segmentation / brain / tumor / guided` | Brain tumor segmentation based on the dual-path network of multi-modal MRI images |
