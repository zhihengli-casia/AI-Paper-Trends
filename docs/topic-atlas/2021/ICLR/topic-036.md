...
1. [An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=YicbFdNTTy)
...
2. [BREEDS: Benchmarks for Subpopulation Shift](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=mQPBmvyAuk)
   - Shibani Santurkar, Dimitris Tsipras, Aleksander Madry; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-q4euywjikqr"></a>
3. [Contemplating Real-World Object Classification](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=Q4EUywJIkqr)
   - ali borji; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-yuxunaj2sl"></a>
4. [Does enhanced shape bias improve neural network robustness to common corruptions?](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=yUxUNaj2Sl)
...
5. [Domain Generalization with MixStyle](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=6xHJ37MVxxp)
   - Kaiyang Zhou, Yongxin Yang, Yu Qiao, Tao Xiang; assignment: `nearest_centroid`; source: `OpenReview`
<a id="paper-qo9-y8also"></a>
6. [Exemplary Natural Images Explain CNN Activations Better than State-of-the-Art Feature Visualization](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=QO9-y8also-)
...
7. [Generalization in data-driven models of primary visual cortex](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=Tp7kI90Htd)
...
8. [Mind the Pad -- CNNs Can Develop Blind Spots](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=m1CD7tPubNy)
...
9. [Noise or Signal: The Role of Image Backgrounds in Object Recognition](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=gl3D-xY7wLq)
...
10. [Robust and Generalizable Visual Representation Learning via Random Convolutions](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=BVSM0x3EDK6)
...
11. [Shape or Texture: Understanding Discriminative Features in CNNs](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=NcFEZOi-rLa)
...
12. [Shape-Texture Debiased Neural Network Training](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=Db4yerZTYkz)
