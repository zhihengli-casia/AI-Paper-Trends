...
1. [Are Neural Nets Modular? Inspecting Functional Modularity Through Differentiable Weight Masks](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=7uVcpu-gMD)
   - Róbert Csordás, Sjoerd van Steenkiste, Jürgen Schmidhuber; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-m5qsh0kbqg"></a>
2. [Deep symbolic regression: Recovering mathematical expressions from data via risk-seeking policy gradients](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=m5Qsh0kBQG)
...
3. [Effective Abstract Reasoning with Dual-Contrast Network](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=ldxlzGYWDmW)
   - Tao Zhuo, Mohan Kankanhalli; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-lsfceb3gyu7"></a>
4. [Emergent Symbols through Binding in External Memory](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=LSFCEb3GYU7)
   - Taylor Whittington Webb, Ishan Sinha, Jonathan Cohen; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-bhcdo-cegcz"></a>
5. [Grounding Physical Concepts of Objects and Events Through Dynamic Visual Reasoning](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=bhCDO_cEGCz)
...
6. [INT: An Inequality Benchmark for Evaluating Generalization in Theorem Proving](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=O6LPudowNQm)
   - Yuhuai Wu, Albert Jiang, Jimmy Ba, Roger Baker Grosse; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-pzj6fzu6wkj"></a>
7. [IsarStep: a Benchmark for High-level Mathematical Reasoning](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=Pzj6fzU6wkj)
   - Wenda Li, Lei Yu, Yuhuai Wu, Lawrence C. Paulson; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-pd-omxh8ilf"></a>
8. [Iterated learning for emergent systematicity in VQA](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=Pd_oMxH8IlF)
...
9. [Learning Reasoning Paths over Semantic Graphs for Video-grounded Dialogues](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=hPWj1qduVw8)
   - Hung Le, Nancy F. Chen, Steven Hoi; assignment: `nearest_centroid`; source: `OpenReview`
<a id="paper-qzbuizq5xr2"></a>
10. [Learning Task-General Representations with Generative Neuro-Symbolic Modeling](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=qzBUIzq5XR2)
   - Reuben Feinman, Brenden M. Lake; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-b7g3-zmhnt0"></a>
11. [Learning to Deceive Knowledge Graph Augmented Models via Targeted Perturbation](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=b7g3_ZMHnT0)
...
12. [Mathematical Reasoning via Self-supervised Skip-tree Training](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=YmqAnY0CMEy)
...
13. [Neural Learning of One-of-Many Solutions for Combinatorial Problems in Structured Output Spaces](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=ATp1nW2FuZL)
   - Yatin Nandwani, Deepanshu Jindal, Mausam ., Parag Singla; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-tgzu6dlbrev"></a>
14. [RNNLogic: Learning Logic Rules for Reasoning on Knowledge Graphs](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=tGZu6DlbreV)
...
15. [Scaling Symbolic Methods using Gradients for Neural Model Explanation](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=V5j-jdoDDP)
...
16. [Teaching Temporal Logics to Neural Networks](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=dOcQK-f4byz)
