...
| [010](topic-010.md) | high-dimensional / algorithm / approximate / guarantees | 12 | 4.38% | 系统/效率/压缩 | `high-dimensional / algorithm / approximate / guarantees` | Rapid Approximate Aggregation with Distribution-Sensitive Interval Guarantees |
