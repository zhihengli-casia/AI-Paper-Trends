...
| [002](topic-002.md) | 图像分割、语义分割与场景解析 | 28 | 5.08% | 计算机视觉 | `video / reasoning / graph / relation` | Dense Relational Image Captioning via Multi-Task Triple-Stream Networks |
| [003](topic-003.md) | 人脸分析、表情与属性建模 | 27 | 4.90% | 计算机视觉 | `face / makeup / facial / identity` | Fast-GANFIT: Generative Adversarial Network for High Fidelity 3D Face Reconstruction |
| [004](topic-004.md) | 图神经网络与图表示学习 | 23 | 4.17% | 图学习/数据挖掘 | `graph / node / gcns / embedding` | EdgeNets: Edge Varying Graph Neural Networks |
| [005](topic-005.md) | 实例分割与开放词汇分割 | 23 | 4.17% | 计算机视觉 | `segmentation / instance / object / semantic` | SOLO: A Simple Framework for Instance Segmentation |
...
| [018](topic-018.md) | 神经架构搜索与模型设计 | 15 | 2.72% | 可信/安全/公平 | `search / nas / neural architecture / routing` | AlphaGAN: Fully Differentiable Architecture Search for Generative Adversarial Networks |
| [019](topic-019.md) | 结构化解析与表示学习 | 13 | 2.36% | 计算机视觉 | `pose / gait / human / monocular` | Monocular 3D Pose Estimation via Pose Grammar and Data Augmentation |
...
| [021](topic-021.md) | 鲁棒性 / pose / camera / correspondences | 13 | 2.36% | 计算机视觉 | `robust / pose / camera / correspondences` | Efficient and Outlier-Robust Simultaneous Pose and Correspondence Determination by Branch-and-Bound and Transformation Decomposition |
...
| [024](topic-024.md) | pruning / compression / quantization / filters | 12 | 2.18% | 计算机视觉 | `pruning / compression / quantization / filters` | Learning End-to-End Lossy Image Compression: A Benchmark |
