...
1. [Arithmetic Sampling: Parallel Diverse Decoding for Large Language Models](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=EfhmBBrXY2)
...
2. [BPipe: Memory-Balanced Pipeline Parallelism for Training Large Language Models](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=HVKmLi1iR4)
...
3. [Cramming: Training a Language Model on a single GPU in one day.](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=2snzoozOWH)
   - Jonas Geiping, Tom Goldstein; assignment: `hdbscan`; source: `PMLR`
<a id="paper-https-proceedings-mlr-press-v202-wang23aa-html"></a>
4. [Data Efficient Neural Scaling Law via Model Reusing](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=iXYnIz4RRx)
...
5. [Fast Inference from Transformers via Speculative Decoding](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=C9NEblP8vS)
...
6. [FlexGen: High-Throughput Generative Inference of Large Language Models with a Single GPU](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=RRntzKrBTp)
...
7. [FlexRound: Learnable Rounding based on Element-wise Division for Post-Training Quantization](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=EPnzNJTYsb)
...
8. [Gradient-Free Structured Pruning with Unlabeled Data](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=Ga6nQOAb7A)
...
9. [LookupFFN: Making Transformers Compute-lite for CPU inference](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=MmYoDC7dH9)
...
10. [Pre-computed memory or on-the-fly encoding? A hybrid approach to retrieval augmentation makes the most of your compute](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=nlUAvrMbUZ)
...
11. [Quantized Distributed Training of Large Models with Convergence Guarantees](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=Nqp8A5IDzq)
...
12. [SmoothQuant: Accurate and Efficient Post-Training Quantization for Large Language Models](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=sHfSV8eYEp)
...
13. [The Flan Collection: Designing Data and Methods for Effective Instruction Tuning](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=ZX4uS605XV)
...
14. [The case for 4-bit precision: k-bit Inference Scaling Laws](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=i8tGb1ab1j)
   - Tim Dettmers, Luke Zettlemoyer; assignment: `hdbscan`; source: `PMLR`
<a id="paper-https-proceedings-mlr-press-v202-wu23k-html"></a>
15. [Understanding Int4 Quantization for Language Models: Latency Speedup, Composability, and Failure Cases](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=q1WGm3hItW)
...
16. [Unit Scaling: Out-of-the-Box Low-Precision Training](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=A8HOsNfish)
