...
| [008](topic-008.md) | feature / cross-domain / invariant / ctr | 8 | 4.85% | 语音/音频/音乐 | `feature / cross-domain / invariant / ctr` | Beyond the Overlapping Users: Cross-Domain Recommendation via Adaptive Anchor Link Learning |
| [009](topic-009.md) | 图神经网络与图表示学习 | 7 | 4.24% | 图学习/数据挖掘 | `classification / node / session / graphs` | Seq-HGNN: Learning Sequential Node Representation on Heterogeneous Graph |
...
| [011](topic-011.md) | 新闻文本、虚假信息与安全检测 | 6 | 3.64% | 推荐/检索/排序 | `news / click / metrics / popularity` | An Offline Metric for the Debiasedness of Click Models |
