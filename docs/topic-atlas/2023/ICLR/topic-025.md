...
5. [Deja Vu: Continual Model Generalization for Unseen Domains](https://openreview.net/forum?id=L8iZdgeKmI6)
   - Chenxi Liu, Lixu Wang, Lingjuan Lyu, Chen Sun, Xiao Wang, Qi Zhu; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-4wm4cy42b81"></a>
6. [Dirichlet-based Uncertainty Calibration for Active Domain Adaptation](https://openreview.net/forum?id=4WM4cy42B81)
   - Mixue Xie, Shuang Li, Rui Zhang, Chi Harold Liu; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-hvrxups3lfa"></a>
7. [Divide to Adapt: Mitigating Confirmation Bias for Domain Adaptation of Black-Box Predictors](https://openreview.net/forum?id=hVrXUps3LFA)
...
8. [Domain Generalization via Heckman-type Selection Models](https://openreview.net/forum?id=fk7RbGibe1)
   - Hyungu Kahng, Hyungrok Do, Judy Zhong; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-pxstyaf2oj5"></a>
9. [Domain-Indexing Variational Bayes: Interpretable Domain Index for Domain Adaptation](https://openreview.net/forum?id=pxStyaf2oJ5)
   - Zihao Xu, Guang-Yuan Hao, Hao He, Hao Wang; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-3dnrkbevatv"></a>
10. [Energy-Based Test Sample Adaptation for Domain Generalization](https://openreview.net/forum?id=3dnrKbeVatv)
   - Zehao Xiao, Xiantong Zhen, Shengcai Liao, Cees G. M. Snoek; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-gptjna57h-3"></a>
11. [Free Lunch for Domain Adversarial Training: Environment Label Smoothing](https://openreview.net/forum?id=GPTjnA57h_3)
...
12. [Interpretations of Domain Adaptations via Layer Variational Analysis](https://openreview.net/forum?id=YtntjusJV6)
   - Huan-Hsin Tseng, Hsin-Yi Lin, Kuo-Hsuan Hung, Yu Tsao; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-uyqks-lilzx"></a>
13. [Modeling the Data-Generating Process is Necessary for Out-of-Distribution Generalization](https://openreview.net/forum?id=uyqks-LILZX)
   - Jivat Neet Kaur, Emre Kiciman, Amit Sharma; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-cgcmwcfgedh"></a>
14. [PGrad: Learning Principal Gradients For Domain Generalization](https://openreview.net/forum?id=CgCmwcfgEdH)
   - Zhe Wang, Jake Grigsby, Yanjun Qi; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-jpq0qhggw3t"></a>
15. [Partial Label Unsupervised Domain Adaptation with Class-Prototype Alignment](https://openreview.net/forum?id=jpq0qHggw3t)
   - Yan Yan, Yuhong Guo; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-h7m-5k5qkjv"></a>
16. [Progressive Mix-Up for Few-Shot Supervised Multi-Source Domain Transfer](https://openreview.net/forum?id=H7M_5K5qKJV)
   - Ronghang Zhu, Ronghang Zhu, Xiang Yu, Sheng Li; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-bqrpez-e5p"></a>
17. [SIMPLE: Specialized Model-Sample Matching for Domain Generalization](https://openreview.net/forum?id=BqrPeZ_e5P)
...
18. [TTN: A Domain-Shift Aware Batch Normalization in Test-Time Adaptation](https://openreview.net/forum?id=EQfeudmWLQ)
   - Hyesu Lim, Byeonggeun Kim, Jaegul Choo, Sungha Choi; assignment: `nearest_centroid`; source: `OpenReview`
<a id="paper-ezltb4m1sbm"></a>
19. [Test-Time Adaptation via Self-Training with Nearest Neighbor Information](https://openreview.net/forum?id=EzLtB4M1SbM)
   - Minguk Jang, Sae-Young Chung, Hye Won Chung; assignment: `nearest_centroid`; source: `OpenReview`
<a id="paper-fjxf1fxn8c"></a>
20. [Towards Understanding GD with Hard and Conjugate Pseudo-labels for Test-Time Adaptation](https://openreview.net/forum?id=FJXf1FXN8C)
   - Jun-Kun Wang, Andre Wibisono; assignment: `nearest_centroid`; source: `OpenReview`
<a id="paper-u2pd6x794i"></a>
21. [When Source-Free Domain Adaptation Meets Learning with Noisy Labels](https://openreview.net/forum?id=u2Pd6x794I)
