...
1. [$\Lambda$-DARTS: Mitigating Performance Collapse by Harmonizing Operation Selection among Cells](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=oztkQizr3kk)
...
2. [DELTA: DEGRADATION-FREE FULLY TEST-TIME ADAPTATION](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=eGm22rqG93)
   - Bowen Zhao, Chen Chen, Shu-Tao Xia; assignment: `nearest_centroid`; source: `OpenReview`
<a id="paper-cqsmmymlp5t"></a>
3. [Git Re-Basin: Merging Models modulo Permutation Symmetries](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=CQsmMYmlP5T)
   - Samuel Ainsworth, Jonathan Hayase, Siddhartha Srinivasa; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-tl8omiibp99"></a>
4. [Improving Differentiable Neural Architecture Search by Encouraging Transferability](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=Tl8OmiibP99)
   - Parth Sheth, Pengtao Xie; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-gu5sj6zggcx"></a>
5. [REPAIR: REnormalizing Permuted Activations for Interpolation Repair](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=gU5sJ6ZggcX)
...
6. [Re-parameterizing Your Optimizers rather than Architectures](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=B92TMCG_7rp)
...
7. [Reparameterization through Spatial Gradient Scaling](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=Kpdewuy7RU6)
...
8. [Transfer NAS with Meta-learned Bayesian Surrogates](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=paGvsrl4Ntr)
   - Gresa Shala, Thomas Elsken, Frank Hutter, Josif Grabocka; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-rwo-ls5gqgn"></a>
9. [ZiCo: Zero-shot NAS via inverse Coefficient of Variation on Gradients](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=rwo-ls5GqGn)
