...
1. [AE-FLOW: Autoencoders with Normalizing Flows for Medical Images Anomaly Detection](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=9OmCr1q54Z)
   - Yuzhong Zhao, Qiaoqiao Ding, Xiaoqun Zhang; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-wc98x1qpdba"></a>
2. [Cycle-consistent Masked AutoEncoder for Unsupervised Domain Generalization](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=wC98X1qpDBA)
...
3. [Discovering Informative and Robust Positives for Video Domain Adaptation](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=vk-j5pQY3Gv)
   - Chang Liu, Kunpeng Li, Michael Stopa, Jun Amano, Yun Fu; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-7ig0wstnd7w"></a>
4. [Domain Generalisation via Domain Adaptation: An Adversarial Fourier Amplitude Approach](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=7IG0wsTND7w)
   - Minyoung Kim, Da Li, Timothy Hospedales; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-qwqm0zwzdrs"></a>
5. [Fake It Until You Make It : Towards Accurate Near-Distribution Novelty Detection](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=QWQM0ZwZdRS)
...
6. [Few-Shot Domain Adaptation For End-to-End Communication](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=4F1gvduDeL)
...
7. [Few-shot Cross-domain Image Generation via Inference-time Latent-code Learning](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=sCYXJr3QJM8)
...
8. [Learning Domain-Agnostic Representation for Disease Diagnosis](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=-HHJZlRpGb)
...
9. [Multi-domain image generation and translation with identifiability guarantees](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=U2g8OGONA_V)
   - Shaoan Xie, Lingjing Kong, Mingming Gong, Kun Zhang; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-1ubnwqc89a"></a>
10. [RGI: robust GAN-inversion for mask-free image inpainting and unsupervised pixel-wise anomaly detection](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=1UbNwQC89a)
...
11. [Rarity Score : A New Metric to Evaluate the Uncommonness of Synthesized Images](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=JTGimap_-F)
...
12. [Sparse Mixture-of-Experts are Domain Generalizable Learners](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=RecZ9nB9Q4)
...
13. [Towards Robust Object Detection Invariant to Real-World Domain Shifts](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=vqSyt8D3ny)
...
14. [Using Language to Extend to Unseen Domains](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=eR2dG8yjnQ)
