# ICLR 2023: 图神经网络与图表示学习：图学习 / 图神经网络

- Topic ID: `7`
- Papers: **26** (1.70%)
- Macro topic: 图学习/数据挖掘
- English keywords: `graph / gnns / nodes / temporal`
- Keyword pool: graph; gnns; nodes; temporal; message; link prediction; expressive; passing; power; higher-order; neighborhood; counting
...
2. [$\rm A^2Q$: Aggregation-Aware Quantization for Graph Neural Networks](https://openreview.net/forum?id=7L2mgi0TNEP)
   - Zeyu Zhu, Fanrong Li, Zitao Mo, Qinghao Hu, Gang Li, Zejian Liu, et al.; assignment: `nearest_centroid`; source: `OpenReview`
...
5. [Agent-based Graph Neural Networks](https://openreview.net/forum?id=8WTAh0tj2jC)
...
6. [Are More Layers Beneficial to Graph Transformers?](https://openreview.net/forum?id=uagC-X9XMi8)
...
7. [Boosting the Cycle Counting Power of Graph Neural Networks with I$^2$-GNNs](https://openreview.net/forum?id=kDSmxOspsXQ)
   - Yinan Huang, Xingang Peng, Jianzhu Ma, Muhan Zhang; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-7d-g8kozkie"></a>
8. [Cycle to Clique (Cy2C) Graph Neural Network: A Sight to See beyond Neighborhood Aggregation](https://openreview.net/forum?id=7d-g8KozkiE)
   - Yun Young Choi, Sun Woo Park, Youngho Woo, U Jin Choi; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-jgmurzm-sb6"></a>
9. [DAG Matters! GFlowNets Enhanced Explainer for Graph Neural Networks](https://openreview.net/forum?id=jgmuRzM-sb6)
...
10. [Deep Ensembles for Graphs with Higher-order Dependencies](https://openreview.net/forum?id=hZftxQGJ4Re)
   - Steven Krieg, William Burgis, Patrick Soga, Nitesh Chawla; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-qamz7q-ta1k"></a>
11. [Direct Embedding of Temporal Network Edges via Time-Decayed Line Graphs](https://openreview.net/forum?id=Qamz7Q_Ta1k)
...
12. [Do We Really Need Complicated Model Architectures For Temporal Networks?](https://openreview.net/forum?id=ayPPc0SyLv1)
...
13. [Equivariant Hypergraph Diffusion Neural Operators](https://openreview.net/forum?id=RiTjKoscnNd)
...
14. [Explaining Temporal Graph Models through an Explorer-Navigator Framework](https://openreview.net/forum?id=BR_ZhvcYbGJ)
...
15. [Fundamental Limits in Formal Verification of Message-Passing Neural Networks](https://openreview.net/forum?id=WlbG820mRH-)
   - Marco Sälzer, Martin Lange; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-8dut3mi-5n"></a>
16. [GReTo: Remedying dynamic graph topology-task discordance via target homophily](https://openreview.net/forum?id=8duT3mi_5n)
...
17. [Graph Neural Network-Inspired Kernels for Gaussian Processes in Semi-Supervised Learning](https://openreview.net/forum?id=flap0Bo6TK_)
   - Zehao Niu, Mihai Anitescu, Jie Chen; assignment: `nearest_centroid`; source: `OpenReview`
<a id="paper-dqnnw2omzl6"></a>
18. [Graph Neural Networks are Inherently Good Generalizers: Insights by Bridging GNNs and MLPs](https://openreview.net/forum?id=dqnNW2omZL6)
   - Chenxiao Yang, Qitian Wu, Jiahua Wang, Junchi Yan; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-m1oqeoaozqu"></a>
19. [Graph Neural Networks for Link Prediction with Subgraph Sketching](https://openreview.net/forum?id=m1oqEOAozQU)
...
20. [Joint Edge-Model Sparse Learning is Provably Efficient for Graph Neural Networks](https://openreview.net/forum?id=4UldFtZ_CVF)
...
21. [LMC: Fast Training of GNNs via Subgraph Sampling with Provable Convergence](https://openreview.net/forum?id=5VBBA91N6n)
   - Zhihao Shi, Xize Liang, Jie Wang; assignment: `nearest_centroid`; source: `OpenReview`
<a id="paper-qu6nicpasi"></a>
22. [Learning Heterogeneous Interaction Strengths by Trajectory Prediction with Graph Neural Network](https://openreview.net/forum?id=qU6NIcpaSi-)
   - Seungwoong Ha, Hawoong Jeong; assignment: `nearest_centroid`; source: `OpenReview`
<a id="paper-c1ns08q9jz"></a>
23. [MetaGL: Evaluation-Free Selection of Graph Learning Models via Meta-Learning](https://openreview.net/forum?id=C1ns08q9jZ)
   - Namyong Park, Ryan A. Rossi, Nesreen Ahmed, Christos Faloutsos; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-r9hnv76kot3"></a>
24. [Rethinking the Expressive Power of GNNs via Graph Biconnectivity](https://openreview.net/forum?id=r9hNv76KoT3)
   - Bohang Zhang, Shengjie Luo, Liwei Wang, Di He; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-t-qvta3paxg"></a>
25. [Serving Graph Compression for Graph Neural Networks](https://openreview.net/forum?id=T-qVtA3pAxG)
...
26. [Towards Open Temporal Graph Neural Networks](https://openreview.net/forum?id=N9Pk5iSCzAn)
