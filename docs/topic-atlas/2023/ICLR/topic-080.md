...
- Keyword pool: vaes; variational; generative; autoencoders; latent; reconstruction; multimodal; depth; scene; coherence; distortion; tests
...
3. [Explicitly Minimizing the Blur Error of Variational Autoencoders](https://openreview.net/forum?id=9krnQ-ue9M)
...
4. [Gromov-Wasserstein Autoencoders](https://openreview.net/forum?id=sbS10BCtc7)
   - Nao Nakagawa, Ren Togo, Takahiro Ogawa, Miki Haseyama; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-sdqgxouelx"></a>
5. [MMVAE+: Enhancing the Generative Quality of Multimodal VAEs without Compromises](https://openreview.net/forum?id=sdQGxouELX)
   - Emanuele Palumbo, Imant Daunhawer, Julia E Vogt; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-oj8asjcamnk"></a>
6. [Multi-Rate VAE: Train Once, Get the Full Rate-Distortion Curve](https://openreview.net/forum?id=OJ8aSjCaMNK)
...
7. [The Tilted Variational Autoencoder: Improving Out-of-Distribution Detection](https://openreview.net/forum?id=YlGsTZODyjz)
   - Griffin Floto, Stefan Kremer, Mihai Nica; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-ewtmdr6ycml"></a>
8. [Trading Information between Latents in Hierarchical Variational Autoencoders](https://openreview.net/forum?id=eWtMdr6yCmL)
   - Tim Z. Xiao, Robert Bamler; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-xjxujha-wpa"></a>
9. [VA-DepthNet: A Variational Approach to Single Image Depth Prediction](https://openreview.net/forum?id=xjxUjHa_Wpa)
