...
2. [Broken Neural Scaling Laws](https://openreview.net/forum?id=sckjveqlCZ)
...
3. [Deep Generative Modeling on Limited Data with Regularization by Nontransferable Pre-trained Models](https://openreview.net/forum?id=M9u_ctqFUlg)
...
4. [ESD: Expected Squared Difference as a Tuning-Free Trainable Calibration Measure](https://openreview.net/forum?id=bHW9njOSON)
...
16. [Scale-invariant Bayesian Neural Networks with Connectivity Tangent Kernel](https://openreview.net/forum?id=VZ5EaTI6dqa)
   - SungYub Kim, Sihwan Park, Kyung-Su Kim, Eunho Yang; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-7i6oza7oij"></a>
17. [Strong inductive biases provably prevent harmless interpolation](https://openreview.net/forum?id=7i6OZa7oij)
   - Michael Aerni, Marco Milanta, Konstantin Donhauser, Fanny Yang; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-p-jiy5qfb7"></a>
18. [Taking a Step Back with KCal: Multi-Class Kernel-Based Calibration for Deep Neural Networks](https://openreview.net/forum?id=p_jIy5QFB7)
...
20. [Tuning Frequency Bias in Neural Network Training with Nonuniform Data](https://openreview.net/forum?id=oLIZ2jGTiv)
   - Annan Yu, Yunan Yang, Alex Townsend; assignment: `nearest_centroid`; source: `OpenReview`
<a id="paper-cxceosf99f"></a>
21. [Understanding Influence Functions and Datamodels via Harmonic Analysis](https://openreview.net/forum?id=cxCEOSF99f)
