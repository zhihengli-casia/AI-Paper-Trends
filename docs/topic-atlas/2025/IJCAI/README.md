...
| [002](topic-002.md) | LoRA 与参数高效微调 | 36 | 2.81% | LLM/语言模型 | `quantization / tensor / llms / quantum` | Exploring the Trade-Offs: Quantization Methods, Task Difficulty, and Model Size in Large Language Models From Edge to Giant |
...
| [009](topic-009.md) | trees / decision / forests / incremental | 25 | 1.95% | 理论/优化 | `trees / decision / forests / incremental` | On the Generalization of Feature Incremental Learning |
| [012](topic-012.md) | 3D Gaussian Splatting 与场景重建 | 24 | 1.88% | 计算机视觉 | `splatting / gaussian / rendering / pose estimation` | Online 3D Gaussian Splatting Modeling with Novel View Selection |
| [013](topic-013.md) | 语音/音频语言模型 | 23 | 1.80% | 生成模型 | `attacks / forgery / adversarial / image` | Secure and Efficient Watermarking for Latent Diffusion Models in Model Distribution Scenarios |
| [014](topic-014.md) | 医疗健康与临床 AI | 22 | 1.72% | LLM/语言模型 | `medical / patient / diagnosis / clinical` | MedualTime: A Dual-Adapter Language Model for Medical Time Series-Text Multimodal Learning |
...
| [032](topic-032.md) | tracking / 运动建模 / object / template | 16 | 1.25% | 多模态/VLM | `tracking / motion / object / template` | Optical Flow Estimation for Tiny Objects: New Problem, Specialized Benchmark, and Bioinspired Scheme |
| [033](topic-033.md) | 公平性、偏见与可信 AI | 16 | 1.25% | 系统/效率/压缩 | `candidates / fairness / voting / approximation` | Efficient Algorithms for Electing Successive Committees |
| [034](topic-034.md) | 目标检测与图像分割 | 16 | 1.25% | 计算机视觉 | `segmentation / images / remote sensing / federated` | RegionMatch: Pixel-Region Collaboration for Semi-Supervised Semantic Segmentation in Remote Sensing Images |
...
| [030](topic-030.md) | dueling / gates / problems / solutions | 16 | 1.25% | LLM/语言模型 | `dueling / gates / problems / solutions` | Scalable Primal Heuristics Using Graph Neural Networks for Combinatorial Optimization (Abstract Reprint) |
| [031](topic-031.md) | 隐私保护与安全学习 | 16 | 1.25% | LLM/语言模型 | `llms / language / source localization / recommendations` | Evaluating and Mitigating Linguistic Discrimination in Large Language Models: Perspectives on Safety Equity and Knowledge Equity |
...
| [039](topic-039.md) | 语音/音频语言模型 | 15 | 1.17% | 语音/音频/音乐 | `music / tracks / poetry / audio` | NotaGen: Advancing Musicality in Symbolic Music Generation with Large Language Model Training Paradigms |
| [043](topic-043.md) | 点云表示与 3D 感知 | 15 | 1.17% | 多模态/VLM | `point cloud / clouds / assembly / object-centric` | IE-PMMA:Point Cloud Completion Through Inverse Edge-aware Upsampling and Precise Multi-Modal Feature Alignment |
...
| [049](topic-049.md) | 隐私保护与安全学习 | 13 | 1.02% | 系统/效率/压缩 | `local search / search algorithm / immunity / cluster` | A Novel Local Search Algorithm for the Vertex Bisection Minimization Problem |
| [050](topic-050.md) | 视频扩散生成与运动控制 | 13 | 1.02% | 计算机视觉 | `shadow / diffusion / style / video` | DiffFERV: Diffusion-based Facial Editing of Real Videos |
...
| [074](topic-074.md) | 医疗健康与临床 AI | 9 | 0.70% | 多模态/VLM | `lung / report / diagnosis / medical` | Explainability Through Human-Centric Design for XAI in Lung Cancer Detection |
