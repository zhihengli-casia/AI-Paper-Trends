...
|---|---|---:|---:|---|---|---|
| [000](topic-000.md) | domain generalization / domain adaptation / target / domains | 65 | 2.26% | 多模态/VLM | `domain generalization / domain adaptation / target / domains` | On the Out-Of-Distribution Generalization of Large Multimodal Models |
| [001](topic-001.md) | 深度估计与立体匹配 | 57 | 1.99% | 计算机视觉 | `depth / estimation / monocular / stereo` | MonSter: Marry Monodepth to Stereo Unleashes Power |
...
| [004](topic-004.md) | 自动驾驶感知与世界模型 | 54 | 1.88% | 多模态/VLM | `driving / autonomous / traffic / lane` | DriveDreamer4D: World Models Are Effective Data Machines for 4D Driving Scene Representation |
| [005](topic-005.md) | 图像复原与超分辨率 | 50 | 1.74% | 计算机视觉 | `mamba / scanning / ssms / linear` | MambaOut: Do We Really Need Mamba for Vision? |
| [006](topic-006.md) | 文生图生成与个性化编辑 | 49 | 1.71% | 生成模型 | `text-to-image / t2i / customization / concepts` | Continuous, Subject-Specific Attribute Control in T2I Models by Identifying Semantic Directions |
...
| [014](topic-014.md) | anomaly / anomalies / detection / normal | 36 | 1.25% | LLM/语言模型 | `anomaly / anomalies / detection / normal` | UniVAD: A Training-free Unified Model for Few-shot Visual Anomaly Detection |
| [015](topic-015.md) | 深度估计与立体匹配 | 35 | 1.22% | 计算机视觉 | `gaussians / splatting / view / synthesis` | GaussianSpa: An "Optimizing-Sparsifying" Simplification Framework for Compact and High-Quality 3D Gaussian Splatting |
| [016](topic-016.md) | 对抗攻击、鲁棒性与安全 | 34 | 1.18% | 计算机视觉 | `adversarial / attacks / defense / threat` | Doppelgangers and Adversarial Vulnerability |
| [017](topic-017.md) | 3D Gaussian Splatting 与场景重建 | 33 | 1.15% | 计算机视觉 | `rendering / gaussian / splatting / reconstruction` | Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives |
| [018](topic-018.md) | 文档摘要与信息压缩 | 33 | 1.15% | LLM/语言模型 | `video / temporal / long / frames` | Re-thinking Temporal Search for Long-Form Video Understanding |
| [019](topic-019.md) | 深度估计与立体匹配 | 32 | 1.11% | 计算机视觉 | `multi-view / video / reconstruction / synthesis` | Zero-Shot Novel View and Depth Synthesis with Multi-View Geometric Diffusion |
| [020](topic-020.md) | 深度估计与立体匹配 | 32 | 1.11% | 计算机视觉 | `event / motion / cameras / temporal resolution` | Event Fields: Capturing Light Fields at High Speed, Resolution, and Dynamic Range |
| [021](topic-021.md) | 目标检测与图像分割 | 32 | 1.11% | 计算机视觉 | `change detection / satellite / remote sensing / sea` | ROS-SAM: High-Quality Interactive Segmentation for Remote Sensing Moving Object |
| [022](topic-022.md) | 语音/音频语言模型 | 31 | 1.08% | LLM/语言模型 | `segmentation / video / sam / frames` | SAM-I2V: Upgrading SAM to Support Promptable Video Segmentation with Less than 0.2% Training Cost |
| [023](topic-023.md) | 视觉语言模型与多模态理解 | 30 | 1.04% | LLM/语言模型 | `prompt / vlms / tuning / consensus` | ProAPO: Progressively Automatic Prompt Optimization for Visual Classification |
| [024](topic-024.md) | 视频动作生成与运动控制 | 30 | 1.04% | LLM/语言模型 | `action / video / temporal / skeleton` | Efficient Transfer Learning for Video-language Foundation Models |
...
| [026](topic-026.md) | 文生图生成与个性化编辑 | 29 | 1.01% | 生成模型 | `svg / vectorization / layout / vector graphics` | DesignDiffusion: High-Quality Text-to-Design Image Generation with Diffusion Models |
...
| [042](topic-042.md) | 隐私保护与安全学习 | 26 | 0.91% | 理论/优化 | `federated / unlearning / client / aggregation` | NoT: Federated Unlearning via Weight Negation |
| [043](topic-043.md) | 点云表示与 3D 感知 | 26 | 0.91% | 3D/具身/机器人 | `object detection / mid-level / point / cloud segmentation` | Learning Class Prototypes for Unified Sparse-Supervised 3D Object Detection |
...
| [056](topic-056.md) | 视觉语言模型与多模态理解 | 23 | 0.80% | 多模态/VLM | `compositional / captions / rec / cropping` | FINECAPTION: Compositional Image Captioning Focusing on Wherever You Want at Any Granularity |
...
| [058](topic-058.md) | 视觉语言模型与多模态理解 | 22 | 0.77% | 多模态/VLM | `open-vocabulary / segmentation / clip / multi-label` | Dual Semantic Guidance for Open Vocabulary Semantic Segmentation |
...
| [060](topic-060.md) | 图像复原与超分辨率 | 21 | 0.73% | 系统/效率/压缩 | `super-resolution / perceptual / sampling / infrared` | Arbitrary-steps Image Super-resolution via Diffusion Inversion |
...
| [062](topic-062.md) | 视频理解/生成 / frames / vae / causal | 20 | 0.70% | 生成模型 | `video / frames / vae / causal` | AR-Diffusion: Asynchronous Video Generation with Auto-Regressive Diffusion |
...
| [064](topic-064.md) | 医疗健康与临床 AI | 20 | 0.70% | 多模态/VLM | `medical / report generation / x-ray / multimodal` | Alignment, Mining and Fusion: Representation Alignment with Hard Negative Mining and Selective Knowledge Fusion for Medical Visual Question Answering |
| [065](topic-065.md) | 视觉语言模型与多模态理解 | 20 | 0.70% | 多模态/VLM | `language / linguistic / vlms / cognitive` | What's in the Image? A Deep-Dive into the Vision of Vision Language Models |
| [066](topic-066.md) | 视觉语言模型与多模态理解 | 20 | 0.70% | 多模态/VLM | `test-time / tta / adaptation / conformal` | Realistic Test-Time Adaptation of Vision-Language Models |
...
| [079](topic-079.md) | 3D Gaussian Splatting 与场景重建 | 16 | 0.56% | 系统/效率/压缩 | `rendering / splatting / gaussian / specular` | IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing |
...
| [089](topic-089.md) | 视频动作生成与运动控制 | 15 | 0.52% | 多模态/VLM | `egocentric / gaze / video / view-invariant` | Object-Shot Enhanced Grounding Network for Egocentric Video |
| [088](topic-088.md) | 医疗健康与临床 AI | 15 | 0.52% | 计算机视觉 | `anatomical / vascular / mri / angiography` | Unraveling Normal Anatomy via Fluid-Driven Anomaly Randomization |
| [090](topic-090.md) | 偏好优化、RLHF 与 DPO | 15 | 0.52% | 生成模型 | `preference / dpo / reward / aesthetics` | Personalized Preference Fine-tuning of Diffusion Models |
| [093](topic-093.md) | 多模态大模型与视觉语言推理 | 15 | 0.52% | 多模态/VLM | `reasoning / critique / multimodal / unit` | VL-RewardBench: A Challenging Benchmark for Vision-Language Generative Reward Models |
| [094](topic-094.md) | 视频扩散生成与运动控制 | 15 | 0.52% | 生成模型 | `video / tokenizer / t2v / multi-prompt` | ShotAdapter: Text-to-Multi-Shot Video Generation with Diffusion Models |
| [092](topic-092.md) | 视觉语言模型与多模态理解 | 15 | 0.52% | LLM/语言模型 | `grounding / reasoning / segmentation / lmms` | Your Large Vision-Language Model Only Needs A Few Attention Heads For Visual Grounding |
...
| [097](topic-097.md) | 语音/音频语言模型 | 14 | 0.49% | 语音/音频/音乐 | `audio / music / video / sound` | MMAudio: Taming Multimodal Joint Training for High-Quality Video-to-Audio Synthesis |
| [098](topic-098.md) | 语音/音频语言模型 | 14 | 0.49% | 多模态/VLM | `event / video / audio-visual / retrieval` | Towards Open-Vocabulary Audio-Visual Event Localization |
...
| [112](topic-112.md) | 状态空间模型与高效序列建模 | 12 | 0.42% | 多模态/VLM | `trajectory / forecasting / trajectories / agents` | MoFlow: One-Step Flow Matching for Human Trajectory Forecasting via Implicit Maximum Likelihood Estimation based Distillation |
| [113](topic-113.md) | 点云表示与 3D 感知 | 12 | 0.42% | 3D/具身/机器人 | `point / completion / cloud / polygonal` | PCDreamer: Point Cloud Completion Through Multi-view Diffusion Priors |
| [114](topic-114.md) | 运动建模 / pressure / pose / egocentric | 12 | 0.42% | 多模态/VLM | `motion / pressure / pose / egocentric` | Ego4o: Egocentric Human Motion Capture and Understanding from Multi-Modal Input |
| [115](topic-115.md) | counting / crowd / semi-supervised / detection | 11 | 0.38% | LLM/语言模型 | `counting / crowd / semi-supervised / detection` | SimLTD: Simple Supervised and Semi-Supervised Long-Tailed Object Detection |
| [116](topic-116.md) | 语音/音频语言模型 | 11 | 0.38% | 多模态/VLM | `emotion / recognition / sentiment / speech` | EMOE: Modality-Specific Enhanced Dynamic Emotion Experts |
...
| [118](topic-118.md) | 搜索排序与相关性建模 | 10 | 0.35% | 推荐/检索/排序 | `re-identification / person / clothing / identity` | From Poses to Identity: Training-Free Person Re-Identification via Feature Centralization |
...
| [120](topic-120.md) | 目标检测与图像分割 | 10 | 0.35% | 计算机视觉 | `wsss / segmentation / weakly supervised / supervised semantic` | Multi-Label Prototype Visual Spatial Search for Weakly Supervised Semantic Segmentation |
