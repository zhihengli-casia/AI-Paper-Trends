...
|---|---|---:|---:|---|---|---|
| [000](topic-000.md) | 目标检测与图像分割 | 65 | 2.79% | 3D/具身/机器人 | `segmentation / semantic / mask / object` | Label-Efficient Few-Shot Semantic Segmentation with Unsupervised Meta-Training |
...
| [016](topic-016.md) | 公平性、偏见与可信 AI | 35 | 1.50% | 多模态/VLM | `federated / clients / heterogeneity / server` | FedASMU: Efficient Asynchronous Federated Learning with Dynamic Staleness-Aware Model Update |
...
| [018](topic-018.md) | 大语言模型 / 推理 / language / 智能体 | 35 | 1.50% | LLM/语言模型 | `llms / reasoning / language / agent` | Hypothesis, Verification, and Induction: Grounding Large Language Models with Self-Driven Skill Learning |
...
| [021](topic-021.md) | Chain-of-Thought 与大模型推理 | 33 | 1.42% | LLM/语言模型 | `llms / language / dialogue / sarcasm` | CK12: A Rounded K12 Knowledge Graph Based Benchmark for Chinese Holistic Cognition Evaluation |
...
| [024](topic-024.md) | 联邦学习与分布式训练 | 32 | 1.37% | 理论/优化 | `domain adaptation / domain generalization / domains / normalization` | Test-Time Domain Adaptation by Learning Domain-Aware Batch Normalization |
...
| [037](topic-037.md) | cross-modal / captioning / image-text / alignment | 25 | 1.07% | 计算机视觉 | `cross-modal / captioning / image-text / alignment` | Improving Cross-Modal Alignment with Synthetic Pairs for Text-Only Image Captioning |
...
| [040](topic-040.md) | 规划搜索与决策推理 | 23 | 0.99% | LLM/语言模型 | `planning / actions / planner / plans` | Learning Planning Domains from Non-redundant Fully-Observed Traces: Theoretical Foundations and Complexity Analysis |
| [041](topic-041.md) | Bandit 与 regret 理论 | 23 | 0.99% | 强化学习/决策 | `regret / bandit / arm / submodular` | Combinatorial Stochastic-Greedy Bandit |
| [042](topic-042.md) | LLM Agent 与工具使用 | 22 | 0.94% | 强化学习/决策 | `allocations / valuations / agents / fair` | Almost Envy-Free Allocations of Indivisible Goods or Chores with Entitlements |
...
| [048](topic-048.md) | surface / point / clouds / geometric | 21 | 0.90% | 3D/具身/机器人 | `surface / point / clouds / geometric` | Arbitrary-Scale Point Cloud Upsampling by Voxel-Based Network with Latent Geometric-Consistent Learning |
...
| [057](topic-057.md) | 推荐系统与用户建模 | 19 | 0.82% | LLM/语言模型 | `human / reinforcement learning / game / agent` | Learning Optimal Advantage from Preferences and Mistaking It for Reward |
| [060](topic-060.md) | margins / sparsity / dnn / batch | 18 | 0.77% | 系统/效率/压缩 | `margins / sparsity / dnn / batch` | Understanding and Leveraging the Learning Phases of Neural Networks |
...
| [068](topic-068.md) | person / reid / re-identification / occluded | 16 | 0.69% | 多模态/VLM | `person / reid / re-identification / occluded` | Text-Based Occluded Person Re-identification via Multi-Granularity Contrastive Consistency Learning |
| [069](topic-069.md) | 视频动作生成与运动控制 | 16 | 0.69% | 多模态/VLM | `tracking / object / frames / template` | M3SOT: Multi-Frame, Multi-Field, Multi-Space 3D Single Object Tracking |
| [070](topic-070.md) | 攻击、防御与模型安全 | 15 | 0.64% | 计算机视觉 | `backdoor / attack / trigger / poisoned` | Does Few-Shot Learning Suffer from Backdoor Attacks? |
| [071](topic-071.md) | quantization / bit / 大语言模型 / quantum | 15 | 0.64% | LLM/语言模型 | `quantization / bit / llms / quantum` | Norm Tweaking: High-Performance Low-Bit Quantization of Large Language Models |
| [072](topic-072.md) | 多模态学习与跨模态理解 | 14 | 0.60% | 多模态/VLM | `relation extraction / document-level / entity / dependency` | Enhancing Low-Resource Relation Representations through Multi-View Decoupling |
