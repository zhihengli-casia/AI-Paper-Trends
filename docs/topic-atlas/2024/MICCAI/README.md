...
| [004](topic-004.md) | 多模态学习与跨模态理解 | 9 | 12.68% | 多模态/VLM | `echocardiography / cardiac / visual / ultrasound` | Cardiac Copilot: Automatic Probe Guidance for Echocardiography with World Model |
| [005](topic-005.md) | 扩散生成模型 | 5 | 7.04% | 生成模型 | `cardiac / lge / myocardial / enhancement` | Myocardial Scar Enhancement in LGE Cardiac MRI Using Localized Diffusion |
| [006](topic-006.md) | 目标检测与图像分割 | 5 | 7.04% | 计算机视觉 | `ultrasound / fetal / musculoskeletal / brain` | Intrapartum Ultrasound Image Segmentation of Pubic Symphysis and Fetal Head Using Dual Student-Teacher Framework with CNN-ViT Collaborative Learning |
