...
| [001](topic-001.md) | 图像复原与超分辨率 | 32 | 6.69% | 计算机视觉 | `restoration / degradations / super-resolution / weather` | Adaptive Blind Super-Resolution Network for Spatial-Specific and Spatial-Agnostic Degradations |
| [002](topic-002.md) | 深度估计与立体匹配 | 30 | 6.28% | 3D/具身/机器人 | `depth / segmentation / object / monocular` | Divide and Conquer: Improving Multi-Camera 3D Perception With 2D Semantic-Depth Priors and Input-Dependent Queries |
...
| [004](topic-004.md) | domain adaptation / uda / org / www | 28 | 5.86% | 计算机视觉 | `domain adaptation / uda / org / www` | Universal and Scalable Weakly-Supervised Domain Adaptation |
| [005](topic-005.md) | 点云表示与 3D 感知 | 24 | 5.02% | 3D/具身/机器人 | `pose / point / rotation / estimation` | Constructing Diverse Inlier Consistency for Partial Point Cloud Registration |
| [006](topic-006.md) | 深度估计与立体匹配 | 23 | 4.81% | 计算机视觉 | `rgb-d / saliency / salient / color` | Salient Object Detection in RGB-D Videos |
...
| [015](topic-015.md) | 多视图聚类与图学习 | 16 | 3.35% | 图学习/数据挖掘 | `multi-view / clustering / anchor / graph` | Dual Consensus Anchor Learning for Fast Multi-View Clustering |
| [013](topic-013.md) | 图像复原与超分辨率 | 16 | 3.35% | 计算机视觉 | `hyperspectral / change / remote sensing / super-resolution` | CS2DIPs: Unsupervised HSI Super-Resolution Using Coupled Spatial and Spectral DIPs |
| [016](topic-016.md) | 医疗健康与临床 AI | 14 | 2.93% | 多模态/VLM | `brain / segmentation / lesions / mri` | Bi-Fusion of Structure and Deformation at Multi-Scale for Joint Segmentation and Registration |
| [017](topic-017.md) | 句法语义解析与结构化表示 | 14 | 2.93% | 计算机视觉 | `parsing / causal / intention / segmentation` | UniParser: Multi-Human Parsing With Unified Correlation Representation Learning |
| [018](topic-018.md) | action / expression / facial / contrastive learning | 12 | 2.51% | 计算机视觉 | `action / expression / facial / contrastive learning` | Cross-Modal Contrastive Learning Network for Few-Shot Action Recognition |
