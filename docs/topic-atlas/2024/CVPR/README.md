...
| [003](topic-003.md) | 点云表示与 3D 感知 | 59 | 2.17% | 3D/具身/机器人 | `segmentation / instance / point / scene` | Open3DIS: Open-Vocabulary 3D Instance Segmentation with 2D Mask Guidance |
...
| [006](topic-006.md) | vit / transformers / vision transformer / registration | 50 | 1.84% | 系统/效率/压缩 | `vit / transformers / vision transformer / registration` | You Only Need Less Attention at Each Stage in Vision Transformers |
| [007](topic-007.md) | 扩散生成模型 | 47 | 1.73% | 生成模型 | `clothed / clothing / avatars / texture` | GALA: Generating Animatable Layered Assets from a Single Scan |
...
| [009](topic-009.md) | 文生图生成与个性化编辑 | 41 | 1.51% | 生成模型 | `diffusion / text-to-image / editing / t2i` | Diff-Plugin: Revitalizing Details for Diffusion-based Low-level Tasks |
...
| [011](topic-011.md) | 扩散生成模型 | 39 | 1.44% | 生成模型 | `protection / copyright / steganographic / diffusion` | Can Protective Perturbation Safeguard Personal Data from Being Exploited by Stable Diffusion? |
...
| [025](topic-025.md) | 查询理解与检索优化 | 33 | 1.22% | 多模态/VLM | `reid / re-identification / person / retrieval` | Dual Pose-invariant Embeddings: Learning Category and Object-specific Discriminative Representations for Recognition and Retrieval |
| [026](topic-026.md) | 图像复原与超分辨率 | 33 | 1.22% | 生成模型 | `super-resolution / resampling / denoising / anime` | Low-Res Leads the Way: Improving Generalization for Super-Resolution by Self-Supervised Learning |
...
| [028](topic-028.md) | 分子表示学习与药物发现 | 32 | 1.18% | 可信/安全/公平 | `ood / labels / uncertainty / noisy` | Improving Generalization via Meta-Learning on Hard Samples |
...
| [031](topic-031.md) | tracking / trackers / association / multi-object | 30 | 1.10% | 计算机视觉 | `tracking / trackers / association / multi-object` | Dense Optical Tracking: Connecting the Dots |
| [032](topic-032.md) | 扩散生成模型 | 30 | 1.10% | 生成模型 | `restoration / super-resolution / diffusion / denoising` | Learning Diffusion Texture Priors for Image Restoration |
...
| [035](topic-035.md) | 社交媒体与社会计算 | 30 | 1.10% | 计算机视觉 | `hoi / interaction / human-object / contact` | CG-HOI: Contact-Guided 3D Human-Object Interaction Generation |
| [036](topic-036.md) | 视频动作生成与运动控制 | 29 | 1.07% | 其他/交叉主题 | `video / motion / flow / frame interpolation` | Sparse Global Matching for Video Frame Interpolation with Large Motion |
...
| [047](topic-047.md) | human pose / pose estimation / pressure / poses | 24 | 0.88% | 计算机视觉 | `human pose / pose estimation / pressure / poses` | FreeMan: Towards Benchmarking 3D Human Pose Estimation under Real-World Conditions |
| [048](topic-048.md) | 文生图生成与个性化编辑 | 24 | 0.88% | 生成模型 | `motion / video / diffusion / editing` | Space-Time Diffusion Features for Zero-Shot Text-Driven Motion Transfer |
| [049](topic-049.md) | 扩散生成模型 | 24 | 0.88% | 生成模型 | `diffusion / sampling / solvers / ode` | Accelerating Diffusion Sampling with Optimized Time Steps |
| [050](topic-050.md) | 对抗攻击、鲁棒性与安全 | 23 | 0.85% | 系统/效率/压缩 | `attacks / backdoor / adversarial / trigger` | Improving Transferable Targeted Adversarial Attacks with Model Self-Enhancement |
...
| [051](topic-051.md) | 自动驾驶感知与世界模型 | 23 | 0.85% | 3D/具身/机器人 | `driving / autonomous / trajectory / motion` | Generalized Predictive Model for Autonomous Driving |
...
| [055](topic-055.md) | 文生图生成与个性化编辑 | 22 | 0.81% | 生成模型 | `text-to-image / personalization / subject / personalized` | Attention Calibration for Disentangled Text-to-Image Personalization |
...
| [076](topic-076.md) | 视频动作生成与运动控制 | 16 | 0.59% | 计算机视觉 | `video / grounding / temporal / shots` | OST: Refining Text Knowledge with Optimal Spatio-Temporal Descriptor for General Video Recognition |
| [077](topic-077.md) | document / layout / scene / spotting | 16 | 0.59% | 多模态/VLM | `document / layout / scene / spotting` | Text Grouping Adapter: Adapting Pre-trained Text Detector for Layout Analysis |
...
| [100](topic-100.md) | 视觉语言模型与多模态理解 | 12 | 0.44% | NLP任务 | `video / answer / question / reasoning` | MoReVQA: Exploring Modular Reasoning Models for Video Question Answering |
| [101](topic-101.md) | 扩散生成模型 | 12 | 0.44% | 计算机视觉 | `sketch / abstraction / retrieval / vector` | It's All About Your Sketch: Democratising Sketch Control in Diffusion Models |
| [102](topic-102.md) | 自动驾驶感知与世界模型 | 11 | 0.41% | LLM/语言模型 | `anomaly / video / surveillance / anomalies` | Harnessing Large Language Models for Training-free Video Anomaly Detection |
| [103](topic-103.md) | action / skeleton / 运动建模 / retargeting | 10 | 0.37% | 多模态/VLM | `action / skeleton / motion / retargeting` | Part-aware Unified Representation of Language and Skeleton for Zero-shot Action Recognition |
...
| [105](topic-105.md) | 对抗攻击、鲁棒性与安全 | 10 | 0.37% | 3D/具身/机器人 | `adversarial / attack / infrared / physical` | PAD: Patch-Agnostic Defense against Adversarial Patch Attacks |
| [106](topic-106.md) | 自动驾驶感知与世界模型 | 10 | 0.37% | 多模态/VLM | `driving / autonomous / language / llms` | LMDrive: Closed-Loop End-to-End Driving with Large Language Models |
