...
|---|---|---:|---:|---|---|---|
| [000](topic-000.md) | face / lip / sketch / gaze | 30 | 6.34% | 计算机视觉 | `face / lip / sketch / gaze` | DeepFacePencil: Creating Face Images from Freehand Sketches |
| [001](topic-001.md) | 多模态学习与跨模态理解 | 26 | 5.50% | 多模态/VLM | `captioning / multimodal / sentences / scene` | Bridging the Gap between Vision and Language Domains for Improved Image Captioning |
| [002](topic-002.md) | 图像复原与超分辨率 | 23 | 4.86% | 系统/效率/压缩 | `compressed / temporal / compression / frames` | RT-VENet: A Convolutional Network for Real-time Video Enhancement |
| [003](topic-003.md) | 联邦学习与分布式训练 | 22 | 4.65% | 推荐/检索/排序 | `re-identification / person / vehicle / reid` | Discriminative Spatial Feature Learning for Person Re-Identification |
...
| [020](topic-020.md) | 句法语义解析与结构化表示 | 12 | 2.54% | 生成模型 | `generative / gans / image generation / face` | F2GAN: Fusing-and-Filling GAN for Few-shot Image Generation |
...
| [022](topic-022.md) | 文档摘要与信息压缩 | 11 | 2.33% | 多模态/VLM | `summarization / sounds / protocol / cross-modal` | Cross-modal Non-linear Guided Attention and Temporal Coherence in Multi-modal Deep Video Models |
| [023](topic-023.md) | action / temporal / concept / event | 11 | 2.33% | 计算机视觉 | `action / temporal / concept / event` | Deep Concept-wise Temporal Convolutional Networks for Action Localization |
| [024](topic-024.md) | 攻击、防御与模型安全 | 11 | 2.33% | 计算机视觉 | `action / skeleton / recognition / gcn` | Spatio-Temporal Inception Graph Convolutional Networks for Skeleton-Based Action Recognition |
| [025](topic-025.md) | 句法语义解析与结构化表示 | 10 | 2.11% | 计算机视觉 | `pose / estimation / hand / parsing` | Alleviating Human-level Shift: A Robust Domain Adaptation Method for Multi-person Pose Estimation |
...
| [027](topic-027.md) | 推荐系统与用户建模 | 10 | 2.11% | 推荐/检索/排序 | `items / recommendation / price / product` | Learning Tuple Compatibility for Conditional Outfit Recommendation |
| [028](topic-028.md) | 多模态学习与跨模态理解 | 9 | 1.90% | 多模态/VLM | `question / reasoning / answering / answers` | Cascade Reasoning Network for Text-based Visual Question Answering |
| [029](topic-029.md) | 多模态学习与跨模态理解 | 8 | 1.69% | 多模态/VLM | `inpainting / description / generation / textual` | Text-Guided Image Inpainting |
