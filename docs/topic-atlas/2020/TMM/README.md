...
| [007](topic-007.md) | 语音/音频语言模型 | 22 | 5.46% | 语音/音频/音乐 | `audio / speech / acoustic / classification` | RealVAD: A Real-World Dataset and A Method for Voice Activity Detection by Body Motion Analysis |
...
| [015](topic-015.md) | body / style / fashion / pose | 12 | 2.98% | 多模态/VLM | `body / style / fashion / pose` | Toward Multi-Modal Conditioned Fashion Image Translation |
| [016](topic-016.md) | person / re-identification / partial / progressive | 11 | 2.73% | 其他/交叉主题 | `person / re-identification / partial / progressive` | Parameter Sharing Exploration and Hetero-Center Triplet Loss for Visible-Thermal Person Re-Identification |
| [017](topic-017.md) | pedestrian / attribute / vehicle / person | 10 | 2.48% | 计算机视觉 | `pedestrian / attribute / vehicle / person` | Hierarchical Reasoning Network for Pedestrian Attribute Recognition |
...
| [020](topic-020.md) | sensing / compression / compressed / jpeg | 8 | 1.99% | 计算机视觉 | `sensing / compression / compressed / jpeg` | Image Compression Based on Compressive Sensing: End-to-End Comparison With JPEG |
