...
| [008](topic-008.md) | style / face / attribute / editing | 32 | 1.95% | 计算机视觉 | `style / face / attribute / editing` | StyleFace: Towards Identity-Disentangled Face Generation on Megapixels |
...
| [018](topic-018.md) | 机器翻译与跨语言对齐 | 25 | 1.52% | 计算机视觉 | `camera / pose / rotation / motion` | RelPose: Predicting Probabilistic Relative Rotation for Single Objects in the Wild |
...
| [020](topic-020.md) | 自动驾驶感知与世界模型 | 24 | 1.46% | 3D/具身/机器人 | `driving / autonomous / bev / perception` | Motion Inspired Unsupervised Perception and Prediction in Autonomous Driving |
...
| [034](topic-034.md) | NeRF 与神经渲染 | 20 | 1.22% | 3D/具身/机器人 | `facial / face / expression / reenactment` | MimicME: A Large Scale Diverse 4D Database for Facial Expression Analysis |
...
| [035](topic-035.md) | LiDAR 点云与 3D 感知 | 20 | 1.22% | 多模态/VLM | `detection / radar / point / clouds` | SpatialDETR: Robust Scalable Transformer-Based 3D Object Detection from Multi-View Camera Images with Global Cross-Sensor Attention |
| [033](topic-033.md) | body / human / try-on / clothed | 20 | 1.22% | 图学习/数据挖掘 | `body / human / try-on / clothed` | LoRD: Local 4D Implicit Representation for High-Fidelity Dynamic Human Modeling |
| [036](topic-036.md) | 视频动作生成与运动控制 | 19 | 1.16% | 系统/效率/压缩 | `video / frames / motion / deblurring` | Towards Interpretable Video Super-Resolution via Alternating Optimization |
...
| [044](topic-044.md) | action / temporal / timestamp / localization | 16 | 0.97% | 可信/安全/公平 | `action / temporal / timestamp / localization` | A Generalized & Robust Framework for Timestamp Supervision in Temporal Action Segmentation |
...
| [052](topic-052.md) | 目标检测与图像分割 | 14 | 0.85% | 计算机视觉 | `segmentation / annotations / panoptic / instance` | Box2Mask: Weakly Supervised 3D Semantic Instance Segmentation Using Bounding Boxes |
| [053](topic-053.md) | 目标检测与图像分割 | 14 | 0.85% | 计算机视觉 | `transformer / vit / detection / window` | A Simple Single-Scale Vision Transformer for Object Detection and Instance Segmentation |
| [054](topic-054.md) | surface / occluding / neural fields / multiview | 14 | 0.85% | 理论/优化 | `surface / occluding / neural fields / multiview` | Intrinsic Neural Fields: Learning Functions on Manifolds |
...
| [057](topic-057.md) | LLM Agent 与工具使用 | 13 | 0.79% | HCI/社会计算 | `trajectory / forecasting / trajectories / pedestrian` | Action-Based Contrastive Learning for Trajectory Prediction |
...
| [076](topic-076.md) | 隐私保护与安全学习 | 10 | 0.61% | 可信/安全/公平 | `face / recognition / threshold / clusters` | Towards Robust Face Recognition with Comprehensive Search |
...
| [078](topic-078.md) | tracking / particle / rppg / cell | 9 | 0.55% | 图学习/数据挖掘 | `tracking / particle / rppg / cell` | Particle Video Revisited: Tracking through Occlusions Using Point Trajectories |
| [079](topic-079.md) | 语音/音频语言模型 | 9 | 0.55% | 语音/音频/音乐 | `audio-visual / speech / sound / speaker` | Audio—Visual Segmentation |
...
| [081](topic-081.md) | ood / out-of-distribution / detection / context | 9 | 0.55% | 理论/优化 | `ood / out-of-distribution / detection / context` | Out-of-Distribution Detection with Boundary Aware Learning |
| [082](topic-082.md) | noisy labels / noise / label correction / clean samples | 8 | 0.49% | 系统/效率/压缩 | `noisy labels / noise / label correction / clean samples` | Active Label Correction Using Robust Parameter Update and Entropy Propagation |
...
| [084](topic-084.md) | counting / crowd / few-shot object / mot | 8 | 0.49% | 计算机视觉 | `counting / crowd / few-shot object / mot` | Few-Shot Object Counting and Detection |
