...
1. [Bayesian Neural Network Priors Revisited](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=xkjqJYqRJy)
...
2. [DriPP: Driven Point Processes to Model Stimuli Induced Patterns in M/EEG Signals](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=d_2lcDh0Y9c)
   - Cédric Allain, Alexandre Gramfort, Thomas Moreau; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-84nmxthye"></a>
3. [Evidential Turing Processes](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=84NMXTHYe-)
...
4. [Multi-Task Processes](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=9otKVlgrpZG)
   - Donggyun Kim, Seongwoong Cho, Wonkwang Lee, Seunghoon Hong; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-tv3n0dwmxcg"></a>
5. [Natural Posterior Network: Deep Bayesian Predictive Uncertainty for Exponential Family Distributions](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=tV3N0DWMxCg)
...
6. [Neural Processes with Stochastic Attention: Paying more attention to the context dataset](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=JPkQwEdYn8)
   - Mingyu Kim, Kyeong Ryeol Go, Se-Young Yun; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-0rcboaobxbg"></a>
7. [Neural Spectral Marked Point Processes](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=0rcbOaoBXbg)
   - Shixiang Zhu, Haoyun Wang, Zheng Dong, Xiuyuan Cheng, Yao Xie; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-3pugbnqoh5m"></a>
8. [Practical Conditional Neural Process Via Tractable Dependent Predictions](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=3pugbNqOh5m)
...
9. [Scale Mixtures of Neural Network Gaussian Processes](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=YVPBh4k78iZ)
   - Hyungi Lee, Eunggu Yun, Hongseok Yang, Juho Lee; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-ksugkcbnf9"></a>
10. [Transformers Can Do Bayesian Inference](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=KSugKcbNf9)
