...
2. [Auto-Transfer: Learning to Route Transferable Representations](https://openreview.net/forum?id=SIKV0_MrZlr)
...
3. [Beyond ImageNet Attack: Towards Crafting Adversarial Examples for Black-box Domains](https://openreview.net/forum?id=QkRV50TZyP)
...
4. [Data Poisoning Won’t Save You From Facial Recognition](https://openreview.net/forum?id=B5XahNLmna)
...
5. [Demystifying Limited Adversarial Transferability in Automatic Speech Recognition Systems](https://openreview.net/forum?id=l5aSHXi8jG5)
...
8. [Non-Transferable Learning: A New Approach for Model Ownership Verification and Applicability Authorization](https://openreview.net/forum?id=tYRrOdSnVUy)
   - Lixu Wang, Shichao Xu, Ruiqi Xu, Xiao Wang, Qi Zhu; assignment: `nearest_centroid`; source: `OpenReview`
<a id="paper-bygszbcm-i"></a>
9. [Online Adversarial Attacks](https://openreview.net/forum?id=bYGSzbCM_i)
...
10. [QUERY EFFICIENT DECISION BASED SPARSE ATTACKS AGAINST BLACK-BOX DEEP LEARNING MODELS](https://openreview.net/forum?id=73MEhZ0anV)
   - Viet Vo, Ehsan M Abbasnejad, Damith Ranasinghe; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-qj1iz-6tinc"></a>
11. [Real-Time Neural Voice Camouflage](https://openreview.net/forum?id=qj1IZ-6TInc)
   - Mia Chiquier, Chengzhi Mao, Carl Vondrick; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-fedfgwvzyin"></a>
12. [RelaxLoss: Defending Membership Inference Attacks without Losing Utility](https://openreview.net/forum?id=FEDfGWVZYIn)
   - Dingfan Chen, Ning Yu, Mario Fritz; assignment: `nearest_centroid`; source: `OpenReview`
<a id="paper-sok-zs6whb"></a>
13. [Responsible Disclosure of Generative Models Using Scalable Fingerprinting](https://openreview.net/forum?id=sOK-zS6WHB)
...
14. [Rethinking Adversarial Transferability from a Data Distribution Perspective](https://openreview.net/forum?id=gVRhIEajG1k)
   - Yao Zhu, Jiacheng Sun, Zhenguo Li; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-nkzq4oeyn"></a>
15. [Sound Adversarial Audio-Visual Navigation](https://openreview.net/forum?id=NkZq4OEYN-)
...
16. [Towards Evaluating the Robustness of Neural Networks Learned by Transduction](https://openreview.net/forum?id=_5js_8uTrx1)
   - Jiefeng Chen, Xi Wu, Yang Guo, Yingyu Liang, Somesh Jha; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-desnw4-5ai9"></a>
17. [Transferable Adversarial Attack based on Integrated Gradients](https://openreview.net/forum?id=DesNW4-5ai9)
