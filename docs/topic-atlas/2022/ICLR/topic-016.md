...
1. [Data-Driven Offline Optimization for Architecting Hardware Accelerators](https://openreview.net/forum?id=GsH-K1VIyy)
...
2. [Generalizing Few-Shot NAS with Gradient Matching](https://openreview.net/forum?id=_jMtny3sMKU)
...
3. [GradMax: Growing Neural Networks using Gradient Information](https://openreview.net/forum?id=qjN4h_wwUO)
...
4. [GradSign: Model Performance Inference with Theoretical Insights](https://openreview.net/forum?id=HObMhrCeAAF)
   - Zhihao Zhang, Zhihao Jia; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-bcrdi4ivvv"></a>
5. [Learning Features with Parameter-Free Layers](https://openreview.net/forum?id=bCrdi4iVvv)
   - Dongyoon Han, YoungJoon Yoo, Beomyoung Kim, Byeongho Heo; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-keql-mz5fg7"></a>
6. [Learning Versatile Neural Architectures by Propagating Network Codes](https://openreview.net/forum?id=KEQl-MZ5fg7)
...
7. [NAS-Bench-Suite: NAS Evaluation is (Now) Surprisingly Easy](https://openreview.net/forum?id=0DLwqQLmqV)
...
8. [NASI: Label- and Data-agnostic Neural Architecture Search at Initialization](https://openreview.net/forum?id=v-v1cpNNK_v)
...
9. [NASPY: Automated Extraction of Automated Machine Learning Models](https://openreview.net/forum?id=KhLK0sHMgXK)
   - Xiaoxuan Lou, Shangwei Guo, Jiwei Li, Yaoxin Wu, Tianwei Zhang; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-8sbpe7rdiv"></a>
10. [NETWORK INSENSITIVITY TO PARAMETER NOISE VIA PARAMETER ATTACK DURING TRAINING](https://openreview.net/forum?id=-8sBpe7rDiV)
   - Julian Büchel, Fynn Firouz Faber, Dylan Richard Muir; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-srtixtysft4"></a>
11. [Neural Parameter Allocation Search](https://openreview.net/forum?id=srtIXtySfT4)
...
12. [On Redundancy and Diversity in Cell-based Neural Architecture Search](https://openreview.net/forum?id=rFJWoYoxrDB)
   - Xingchen Wan, Binxin Ru, Pedro M Esperança, Zhenguo Li; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-7b3ijmm1k-m"></a>
13. [Optimal ANN-SNN Conversion for High-accuracy and Ultra-low-latency Spiking Neural Networks](https://openreview.net/forum?id=7B3IJMM1k_M)
...
14. [RotoGrad: Gradient Homogenization in Multitask Learning](https://openreview.net/forum?id=T8wHz4rnuGL)
   - Adrián Javaloy, Isabel Valera; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-z8fzvvu6-kj"></a>
15. [SUMNAS: Supernet with Unbiased Meta-Features for Neural Architecture Search](https://openreview.net/forum?id=Z8FzvVU6_Kj)
   - Hyeonmin Ha, Ji-Hoon Kim, Semin Park, Byung-Gon Chun; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-bp-lj4y-xc"></a>
16. [Sequence Approximation using Feedforward Spiking Neural Network for Spatiotemporal Learning: Theory and Optimization Methods](https://openreview.net/forum?id=bp-LJ4y_XC)
   - Xueyuan She, Saurabh Dash, Saibal Mukhopadhyay; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-imh1e5k7n3l"></a>
17. [Spike-inspired rank coding for fast and accurate recurrent neural networks](https://openreview.net/forum?id=iMH1e5k7n3L)
...
18. [Surrogate NAS Benchmarks: Going Beyond the Limited Search Spaces of Tabular NAS Benchmarks](https://openreview.net/forum?id=OnpFa95RVqs)
...
19. [Temporal Efficient Training of Spiking Neural Network via Gradient Re-weighting](https://openreview.net/forum?id=_XNtisL32jv)
   - Shikuang Deng, Yuhang Li, Shanghang Zhang, Shi Gu; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-mvo2t0vbs4"></a>
20. [Wisdom of Committees: An Overlooked Approach To Faster and More Accurate Models](https://openreview.net/forum?id=MvO2t0vbs4-)
...
21. [X-model: Improving Data Efficiency in Deep Learning with A Minimax Model](https://openreview.net/forum?id=P3Bh01hBYTH)
