...
3. [Bayesian Framework for Gradient Leakage](https://openreview.net/forum?id=f2lrIbGx3x7)
...
4. [Byzantine-Robust Learning on Heterogeneous Datasets via Bucketing](https://openreview.net/forum?id=jXKKDEi5vJt)
   - Sai Praneeth Karimireddy, Lie He, Martin Jaggi; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-nwkxyfvaum"></a>
5. [Diverse Client Selection for Federated Learning via Submodular Maximization](https://openreview.net/forum?id=nwKXyFvaUm)
...
6. [Efficient Split-Mix Federated Learning for On-Demand and In-Situ Customization](https://openreview.net/forum?id=_QLmakITKg)
   - Junyuan Hong, Haotao Wang, Zhangyang Wang, Jiayu Zhou; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-huayqfggn5u"></a>
7. [FedBABU: Toward Enhanced Representation for Federated Image Classification](https://openreview.net/forum?id=HuaYQfggn5u)
   - Jaehoon Oh, SangMook Kim, Se-Young Yun; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-zavvvlcdan"></a>
8. [FedChain: Chained Algorithms for Near-optimal Communication Cost in Federated Learning](https://openreview.net/forum?id=ZaVVVlcdaN)
...
9. [FedPara: Low-rank Hadamard Product for Communication-Efficient Federated Learning](https://openreview.net/forum?id=d71n4ftoCBy)
   - Nam Hyeon-Woo, Moon Ye-Bin, Tae-Hyun Oh; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-wha8009laxu"></a>
10. [Federated Learning from Only Unlabeled Data with Class-conditional-sharing Clients](https://openreview.net/forum?id=WHA8009laxu)
...
11. [Hybrid Local SGD for Federated Learning with Heterogeneous Communications](https://openreview.net/forum?id=H0oaWl6THa)
   - Yuanxiong Guo, Ying Sun, Rui Hu, Yanmin Gong; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-7l1ijzvdddw"></a>
12. [Improving Federated Learning Face Recognition via Privacy-Agnostic Clusters](https://openreview.net/forum?id=7l1IjZVddDW)
...
13. [On Bridging Generic and Personalized Federated Learning for Image Classification](https://openreview.net/forum?id=I1hQbx10Kxn)
   - Hong-You Chen, Wei-Lun Chao; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-b7zbqnldn"></a>
14. [Recycling Model Updates in Federated Learning: Are Gradient Subspaces Low-Rank?](https://openreview.net/forum?id=B7ZbqNLDn-_)
...
15. [Robbing the Fed: Directly Obtaining Private Data in Federated Learning with Modified Models](https://openreview.net/forum?id=fwzUgo0FM9v)
...
16. [Towards Model Agnostic Federated Learning Using Knowledge Distillation](https://openreview.net/forum?id=lQI_mZjvBxj)
   - Andrei Afonin, Sai Praneeth Karimireddy; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-vimqqq-i-q"></a>
17. [What Do We Mean by Generalization in Federated Learning?](https://openreview.net/forum?id=VimqQq-i_Q)
...
18. [ZeroFL: Efficient On-Device Training for Federated Learning with Local Sparsity](https://openreview.net/forum?id=2sDQwC_hmnM)
