...
1. [Delaunay Component Analysis for Evaluation of Data Representations](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=HTVch9AMPa)
...
2. [End-to-End Learning of Probabilistic Hierarchies on Graphs](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=g2LCQwG7Of)
...
3. [Evaluation Metrics for Graph Generative Models: Problems, Pitfalls, and Practical Solutions](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=tBtoZYKd9n)
   - Leslie O'Bray, Max Horn, Bastian Rieck, Karsten Borgwardt; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-0kpl3xo4r5"></a>
4. [Fast topological clustering with Wasserstein distance](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=0kPL3xO4R5)
...
5. [Graph Auto-Encoder via Neighborhood Wasserstein Reconstruction](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=ATUh28lnSuW)
   - Mingyue Tang, Pan Li, Carl Yang; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-usigiy6tnde"></a>
6. [Graph-based Nearest Neighbor Search in Hyperbolic Spaces](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=USIgIY6TNDe)
...
7. [Graphon based Clustering and Testing of Networks: Algorithms and Theory](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=sTNHCrIKDQc)
...
8. [On Evaluation Metrics for Graph Generative Models](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=EnwCZixjSh)
...
9. [Semi-relaxed Gromov-Wasserstein divergence and applications on graphs](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=RShaMexjc-x)
