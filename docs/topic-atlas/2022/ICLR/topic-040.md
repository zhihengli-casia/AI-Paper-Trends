...
1. [Coordination Among Neural Modules Through a Shared Global Workspace](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=XzTtHjgPDsT)
...
2. [Curriculum learning as a tool to uncover learning principles in the brain](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=TpJMvo0_pu-)
   - Daniel R. Kepple, Rainer Engelken, Kanaka Rajan; assignment: `nearest_centroid`; source: `OpenReview`
<a id="paper-uylfoz1vlac"></a>
3. [Efficiently Modeling Long Sequences with Structured State Spaces](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=uYLFoz1vlAC)
   - Albert Gu, Karan Goel, Christopher Re; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-augbfdiv9rl"></a>
4. [Emergent Communication at Scale](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=AUGBfDIV9rL)
...
5. [Expressivity of Emergent Languages is a Trade-off between Contextual Complexity and Unpredictability](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=WxuE_JWxjkW)
...
6. [Learning Hierarchical Structures with Differentiable Nondeterministic Stacks](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=5LXw_QplBiF)
   - Brian DuSell, David Chiang; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-vwj6aueocyf"></a>
7. [Long Expressive Memory for Sequence Modeling](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=vwj6aUeocyf)
...
8. [On the approximation properties of recurrent encoder-decoder architectures](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=xDIvIqQ3DXD)
   - Zhong Li, Haotian Jiang, Qianxiao Li; assignment: `hdbscan`; source: `OpenReview`
<a id="paper-5qkd7-bzfi"></a>
9. [On the role of population heterogeneity in emergent communication](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=5Qkd7-bZfI)
...
10. [Relating transformers to models and neural representations of the hippocampal formation](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=B8DVo9B1YE0)
   - James C. R. Whittington, Joseph Warren, Tim E.J. Behrens; assignment: `nearest_centroid`; source: `OpenReview`
<a id="paper-3wncr5nq56"></a>
11. [The Uncanny Similarity of Recurrence and Depth](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=3wNcr5nq56)
...
12. [Transformer Embeddings of Irregularly Spaced Events and Their Participants](https://r.jina.ai/http://r.jina.ai/http://https://openreview.net/forum?id=Rty5g9imm7H)
